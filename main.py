...
from app.routers import chatbot, returnCSI, inventoryadvisor, associationbucketmaker, whalehunter, priceadvisor # <--- ADDED priceadvisor IMPORT
...
app.include_router(priceadvisor.router, prefix=f"{settings.API_V1_STR}/price-advisor", tags=["Price Advisor"])